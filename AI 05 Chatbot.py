...
responses = {
    ...
    "what services you can provide": "We offer the following services:\n- IT Support\n- Software Development\n- Cloud Computing\n- Data Analytics\nWhich service are you interested in?",
...
def get_response(user_input):
    ...
    elif "what services you can provide" in user_input:
        return responses["what services you can provide"]
